...
// ["'add(A)_in(A)-t-0'", "'add(A)_remove(B)'", "'add(A)_in(B)-f-0'", "'in(A)-f-0_in(B)-t-0'", "'add(B)_in(A)-f-0'", "'add(B)_in(B)-t-0'", "'remove(B)_in(A)-t-0'", "'in(B)-f-0_in(A)-t-0'", "'in(B)-f-0_remove(B)'"]
set_t set;
