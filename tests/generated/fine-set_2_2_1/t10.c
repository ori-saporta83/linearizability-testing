...
// ["'in(A)-t-0_in(A)-t-1'", "'in(A)-t-0_remove(B)'", "'in(A)-t-0_in(B)-f-0'", "'in(A)-f-0_in(B)-t-0'", "'remove(B)_in(A)-t-1'", "'in(B)-t-1_in(A)-f-0'", "'in(B)-t-1_in(B)-t-0'", "'in(B)-f-0_in(A)-t-1'", "'in(B)-f-0_remove(B)'"]
set_t set;
