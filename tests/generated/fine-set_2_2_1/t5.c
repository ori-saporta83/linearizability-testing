...
// ["'in(A)-t-0_remove(A)'", "'in(A)-t-0_add(B)'", "'in(A)-t-0_in(B)-f-0'", "'in(A)-f-0_remove(B)'", "'add(B)_remove(A)'", "'add(B)_in(B)-f-0'", "'in(B)-t-0_in(A)-f-0'", "'in(B)-t-0_remove(B)'", "'in(B)-f-0_remove(A)'"]
set_t set;
