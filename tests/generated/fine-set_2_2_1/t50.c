...
// ["'add(A)_in(A)-t-1'", "'add(A)_in(B)-f-0'", "'remove(A)_remove(B)'", "'in(A)-f-0_remove(A)'", "'in(A)-f-0_remove(B)'", "'add(B)_remove(A)'", "'add(B)_in(A)-f-0'", "'add(B)_remove(B)'", "'in(B)-f-0_in(A)-t-1'"]
set_t set;
