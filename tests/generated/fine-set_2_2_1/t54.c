...
// ["'add(A)_in(A)-t-1'", "'add(A)_in(B)-f-0'", "'remove(A)_in(B)-t-0'", "'in(A)-f-0_remove(A)'", "'in(A)-f-0_in(B)-t-0'", "'add(B)_remove(A)'", "'add(B)_in(A)-f-0'", "'add(B)_in(B)-t-0'", "'in(B)-f-0_in(A)-t-1'"]
set_t set;
