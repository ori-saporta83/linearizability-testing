...
// ["'remove(A)_in(B)-t-1'", "'in(A)-t-1_in(A)-t-0'", "'in(A)-t-1_in(B)-f-0'", "'in(A)-f-0_remove(A)'", "'in(A)-f-0_in(B)-t-1'", "'add(B)_remove(A)'", "'add(B)_in(A)-f-0'", "'add(B)_in(B)-t-1'", "'in(B)-f-0_in(A)-t-0'"]
set_t set;
