...
// ["'in(A)-t-0_in(A)-t-1'", "'in(A)-t-0_add(B)'", "'in(A)-t-0_in(B)-f-0'", "'in(A)-f-0_in(B)-t-1'", "'add(B)_in(A)-t-1'", "'add(B)_in(B)-f-0'", "'in(B)-t-0_in(A)-f-0'", "'in(B)-t-0_in(B)-t-1'", "'in(B)-f-0_in(A)-t-1'"]
set_t set;
