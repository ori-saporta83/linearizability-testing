...
// ["'add(A)_in(A)-f-0'", "'add(A)_remove(B)'", "'in(A)-t-0_in(A)-t-1'", "'in(A)-t-0_in(B)-f-0'", "'in(A)-f-0_remove(B)'", "'in(B)-t-0_add(A)'", "'in(B)-t-0_in(A)-f-0'", "'in(B)-t-0_remove(B)'", "'in(B)-f-0_in(A)-t-1'"]
set_t set;
