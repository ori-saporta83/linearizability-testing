...
// ["'remove(A)_remove(B)'", "'in(A)-t-1_in(A)-t-0'", "'in(A)-t-1_in(B)-f-0'", "'in(A)-f-0_remove(A)'", "'in(A)-f-0_remove(B)'", "'in(B)-t-0_remove(A)'", "'in(B)-t-0_in(A)-f-0'", "'in(B)-t-0_remove(B)'", "'in(B)-f-0_in(A)-t-0'"]
set_t set;
