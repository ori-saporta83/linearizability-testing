...
// ["'add(A)_in(A)-f-0'", "'add(A)_remove(C)'", "'add(A)_in(C)-f-0'", "'in(A)-f-0_remove(C)'", "'in(A)-f-0_in(C)-f-0'", "'add(B)_remove(A)'", "'in(B)-f-0_remove(B)'", "'add(C)_remove(B)'", "'add(C)_in(B)-f-0'", "'in(C)-f-0_remove(C)'"]
set_t set;
