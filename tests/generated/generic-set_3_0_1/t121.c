...
// ["'add(A)_in(A)-f-0'", "'add(A)_remove(B)'", "'in(A)-f-0_remove(B)'", "'add(B)_in(B)-f-0'", "'add(B)_remove(C)'", "'add(B)_in(C)-f-0'", "'in(B)-f-0_remove(C)'", "'in(B)-f-0_in(C)-f-0'", "'add(C)_remove(A)'", "'in(C)-f-0_remove(C)'"]
set_t set;
