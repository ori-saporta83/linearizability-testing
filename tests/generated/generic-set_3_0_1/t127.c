...
// ["'add(A)_in(B)-f-0'", "'add(A)_remove(C)'", "'in(A)-f-0_remove(C)'", "'add(B)_in(A)-f-0'", "'add(B)_remove(C)'", "'in(B)-f-0_remove(C)'", "'add(C)_remove(A)'", "'add(C)_remove(B)'", "'add(C)_in(C)-f-0'", "'in(C)-f-0_remove(A)'", "'in(C)-f-0_remove(B)'"]
set_t set;
