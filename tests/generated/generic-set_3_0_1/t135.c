...
// ["'add(A)_remove(A)'", "'add(A)_in(B)-f-0'", "'add(A)_remove(C)'", "'add(A)_in(C)-f-0'", "'in(A)-f-0_remove(B)'", "'in(A)-f-0_add(C)'", "'add(B)_in(A)-f-0'", "'add(B)_remove(B)'", "'add(B)_add(C)'", "'in(B)-f-0_remove(A)'", "'in(B)-f-0_remove(C)'", "'in(B)-f-0_in(C)-f-0'", "'add(C)_remove(B)'", "'remove(C)_remove(A)'", "'in(C)-f-0_remove(A)'", "'in(C)-f-0_remove(C)'"]
set_t set;
