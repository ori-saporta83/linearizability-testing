...
// ["'add(A)_remove(A)'", "'add(A)_in(B)-f-0'", "'add(A)_remove(C)'", "'in(A)-f-0_remove(B)'", "'in(A)-f-0_add(C)'", "'in(A)-f-0_in(C)-f-0'", "'add(B)_in(A)-f-0'", "'add(B)_remove(B)'", "'add(B)_add(C)'", "'add(B)_in(C)-f-0'", "'in(B)-f-0_remove(A)'", "'in(B)-f-0_remove(C)'", "'add(C)_remove(B)'", "'add(C)_in(C)-f-0'", "'remove(C)_remove(A)'", "'in(C)-f-0_remove(B)'"]
set_t set;
