...
// ["'add(A)_remove(B)'", "'in(A)-f-0_remove(A)'", "'add(B)_remove(C)'", "'add(B)_in(C)-f-0'", "'in(B)-f-0_remove(A)'", "'in(B)-f-0_in(A)-f-0'", "'add(C)_remove(A)'", "'add(C)_in(A)-f-0'", "'add(C)_in(B)-f-0'", "'in(C)-f-0_remove(C)'"]
set_t set;
