...
// ["'add(A)_remove(A)'", "'add(A)_add(B)'", "'add(A)_in(B)-f-0'", "'add(A)_in(C)-f-0'", "'in(A)-f-0_remove(C)'", "'add(B)_remove(A)'", "'add(B)_in(B)-f-0'", "'add(B)_in(C)-f-0'", "'remove(B)_in(A)-f-0'", "'remove(B)_remove(C)'", "'in(B)-f-0_remove(A)'", "'in(B)-f-0_in(C)-f-0'", "'add(C)_in(A)-f-0'", "'add(C)_remove(B)'", "'add(C)_remove(C)'", "'in(C)-f-0_remove(A)'"]
set_t set;
