...
// ["'add(A)_remove(B)'", "'add(A)_in(B)-f-0'", "'in(A)-f-0_remove(C)'", "'add(B)_remove(A)'", "'add(B)_in(A)-f-0'", "'add(B)_remove(C)'", "'add(B)_in(C)-f-0'", "'in(B)-f-0_remove(B)'", "'add(C)_remove(B)'", "'add(C)_in(B)-f-0'", "'in(C)-f-0_remove(A)'"]
set_t set;
