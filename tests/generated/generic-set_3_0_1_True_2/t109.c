...
// ["'add(A)_remove(B)'", "'add(A)_in(C)-f-0'", "'in(A)-f-0_remove(B)'", "'add(B)_remove(A)'", "'add(B)_in(B)-f-0'", "'add(B)_remove(C)'", "'in(B)-f-0_remove(A)'", "'in(B)-f-0_remove(C)'", "'add(C)_in(A)-f-0'", "'add(C)_remove(B)'", "'in(C)-f-0_remove(B)'"]
set_t set;
