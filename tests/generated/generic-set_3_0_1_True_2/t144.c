...
// ["'add(A)_remove(B)'", "'in(A)-f-0_remove(C)'", "'add(B)_remove(A)'", "'add(B)_in(A)-f-0'", "'add(B)_in(B)-f-0'", "'add(B)_remove(C)'", "'add(B)_in(C)-f-0'", "'in(B)-f-0_remove(A)'", "'in(B)-f-0_in(A)-f-0'", "'in(B)-f-0_remove(C)'", "'in(B)-f-0_in(C)-f-0'", "'add(C)_remove(B)'", "'in(C)-f-0_remove(A)'"]
set_t set;
