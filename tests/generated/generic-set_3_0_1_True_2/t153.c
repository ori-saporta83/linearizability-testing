...
// ["'add(A)_in(A)-f-0'", "'add(A)_remove(B)'", "'remove(A)_remove(C)'", "'in(A)-f-0_remove(B)'", "'add(B)_add(A)'", "'add(B)_in(A)-f-0'", "'add(B)_remove(B)'", "'add(B)_in(C)-f-0'", "'in(B)-f-0_remove(A)'", "'in(B)-f-0_remove(C)'", "'add(C)_remove(A)'", "'add(C)_in(B)-f-0'", "'add(C)_remove(C)'", "'in(C)-f-0_add(A)'", "'in(C)-f-0_in(A)-f-0'", "'in(C)-f-0_remove(B)'"]
set_t set;
