...
// ["'add(A)_remove(A)'", "'add(A)_in(B)-f-0'", "'add(A)_add(C)'", "'add(A)_in(C)-f-0'", "'in(A)-f-0_remove(B)'", "'in(A)-f-0_remove(C)'", "'add(B)_in(A)-f-0'", "'add(B)_remove(B)'", "'add(B)_remove(C)'", "'in(B)-f-0_remove(A)'", "'in(B)-f-0_add(C)'", "'in(B)-f-0_in(C)-f-0'", "'add(C)_remove(A)'", "'add(C)_in(C)-f-0'", "'remove(C)_remove(B)'", "'in(C)-f-0_remove(A)'"]
set_t set;
