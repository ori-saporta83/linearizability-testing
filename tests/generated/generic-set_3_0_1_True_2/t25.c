...
// ["'add(A)_in(B)-f-0'", "'add(A)_remove(C)'", "'add(A)_in(C)-f-0'", "'in(A)-f-0_remove(A)'", "'add(B)_remove(A)'", "'add(B)_in(A)-f-0'", "'in(B)-f-0_remove(C)'", "'in(B)-f-0_in(C)-f-0'", "'add(C)_remove(B)'", "'in(C)-f-0_remove(C)'"]
set_t set;
