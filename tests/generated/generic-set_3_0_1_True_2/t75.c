...
// ["'add(A)_in(A)-f-0'", "'add(A)_remove(C)'", "'in(A)-f-0_remove(C)'", "'add(B)_remove(A)'", "'in(B)-f-0_remove(B)'", "'add(C)_remove(B)'", "'add(C)_in(B)-f-0'", "'add(C)_in(C)-f-0'", "'in(C)-f-0_remove(B)'", "'in(C)-f-0_in(B)-f-0'"]
set_t set;
