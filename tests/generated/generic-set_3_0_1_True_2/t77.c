...
// ["'add(A)_remove(B)'", "'in(A)-f-0_remove(A)'", "'add(B)_in(B)-f-0'", "'add(B)_remove(C)'", "'in(B)-f-0_remove(C)'", "'add(C)_remove(A)'", "'add(C)_in(A)-f-0'", "'add(C)_in(C)-f-0'", "'in(C)-f-0_remove(A)'", "'in(C)-f-0_in(A)-f-0'"]
set_t set;
