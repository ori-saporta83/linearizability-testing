...
// ["'add(A)_in(A)-f-0'", "'add(A)_remove(B)'", "'add(A)_remove(C)'", "'in(A)-f-0_remove(B)'", "'in(A)-f-0_remove(C)'", "'add(B)_remove(A)'", "'add(B)_in(C)-f-0'", "'in(B)-f-0_remove(A)'", "'add(C)_remove(A)'", "'add(C)_in(B)-f-0'", "'in(C)-f-0_remove(A)'"]
set_t set;
