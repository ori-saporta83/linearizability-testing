...
// ["'add(A)_remove(A)'", "'add(A)_remove(B)'", "'add(A)_in(B)-f-0'", "'add(A)_in(C)-f-0'", "'in(A)-f-0_add(B)'", "'in(A)-f-0_remove(C)'", "'add(B)_remove(C)'", "'remove(B)_remove(A)'", "'in(B)-f-0_remove(A)'", "'in(B)-f-0_remove(B)'", "'add(C)_in(A)-f-0'", "'add(C)_add(B)'", "'add(C)_remove(C)'", "'in(C)-f-0_remove(A)'", "'in(C)-f-0_remove(B)'", "'in(C)-f-0_in(B)-f-0'"]
set_t set;
