...
// ["'add(A)_remove(B)'", "'in(A)-f-0_remove(C)'", "'add(B)_in(A)-f-0'", "'add(B)_in(B)-f-0'", "'add(B)_remove(C)'", "'in(B)-f-0_in(A)-f-0'", "'in(B)-f-0_remove(C)'", "'add(C)_remove(A)'", "'add(C)_in(C)-f-0'", "'in(C)-f-0_remove(A)'"]
set_t set;
