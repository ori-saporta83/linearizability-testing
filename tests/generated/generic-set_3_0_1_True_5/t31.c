...
// ["'add(A)_remove(C)'", "'remove(A)_remove(B)'", "'in(A)-f-0_remove(A)'", "'in(A)-f-0_remove(B)'", "'add(B)_remove(A)'", "'add(B)_in(A)-f-0'", "'add(B)_remove(B)'", "'add(B)_in(C)-f-0'", "'in(B)-f-0_add(A)'", "'in(B)-f-0_remove(C)'", "'add(C)_add(A)'", "'add(C)_in(B)-f-0'", "'add(C)_remove(C)'", "'in(C)-f-0_remove(A)'", "'in(C)-f-0_in(A)-f-0'", "'in(C)-f-0_remove(B)'"]
set_t set;
