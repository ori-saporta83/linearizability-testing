...
// ["'add(A)_remove(C)'", "'add(A)_in(C)-f-0'", "'in(A)-f-0_remove(B)'", "'add(B)_remove(C)'", "'add(B)_in(C)-f-0'", "'in(B)-f-0_remove(A)'", "'add(C)_remove(A)'", "'add(C)_in(A)-f-0'", "'add(C)_remove(B)'", "'add(C)_in(B)-f-0'", "'in(C)-f-0_remove(C)'"]
set_t set;
