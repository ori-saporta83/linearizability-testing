...
// ["'add(A)_remove(A)'", "'add(A)_remove(B)'", "'add(A)_in(C)-f-0'", "'in(A)-f-0_remove(C)'", "'add(B)_in(A)-f-0'", "'add(B)_in(B)-f-0'", "'add(B)_remove(C)'", "'remove(B)_remove(A)'", "'remove(B)_in(C)-f-0'", "'in(B)-f-0_in(A)-f-0'", "'in(B)-f-0_remove(C)'", "'add(C)_in(A)-f-0'", "'add(C)_add(B)'", "'add(C)_in(B)-f-0'", "'add(C)_remove(C)'", "'in(C)-f-0_remove(A)'"]
set_t set;
